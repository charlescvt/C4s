...
def user_input(st_ticker, st_quarter):
        ...
        print ("Received ser input in " + str(end-start) + "seconds")
...
def ask_chatgpt(prompt=None):
    ...
    *_, response = chatbot.ask(prompt, conversation_id='e1d078ff-9158-42e0-8cfc-6ae031219900')
